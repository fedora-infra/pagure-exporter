...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status FULL --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce ZEROEXISTENT --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts",  # noqa: E501
            1,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest ZEROEXISTENT --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN",  # noqa: E501
            1,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --commit --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --commit --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --secret --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --secret --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --select 1 --commit --comments --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --select 2 --commit --comments --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --select 1 --series",  # noqa: E501
            0,
            [
                "[ WARN ] Extracting all closed issue tickets without labels, without states, without privacy, without comments and with order off the given selection",  # noqa: E501
                "[ BUSY ] Probing issue ticket #1...",
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status FULL --commit --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --labels --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --labels --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status FULL --labels --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --comments --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --comments --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status FULL --comments --series",  # noqa: E501
            0,
            [
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --ranges 1 2 --series",  # noqa: E501
            0,
            [
                "[ WARN ] Extracting all open issue tickets without labels, without states, without privacy, without comments and with order off the given selection",  # noqa: E501
                "[ BUSY ] Probing issue ticket #1...",
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --ranges 1 2 --series",  # noqa: E501
            0,
            [
                "[ WARN ] Extracting all closed issue tickets without labels, without states, without privacy, without comments and with order off the given selection",  # noqa: E501
                "[ BUSY ] Probing issue ticket #1...",
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status FULL --ranges 1 2 --series",  # noqa: E501
            0,
            [
                "[ WARN ] Extracting all issue tickets without labels, without states, without privacy, without comments and with order off the given selection",  # noqa: E501
                "[ BUSY ] Probing issue ticket #1...",
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status OPEN --select 1,2 --series",  # noqa: E501
            0,
            [
                "[ WARN ] Extracting all open issue tickets without labels, without states, without privacy, without comments and with order off the given selection",  # noqa: E501
                "[ BUSY ] Probing issue ticket #1...",
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status SHUT --select 1,2 --series",  # noqa: E501
            0,
            [
                "[ WARN ] Extracting all closed issue tickets without labels, without states, without privacy, without comments and with order off the given selection",  # noqa: E501
                "[ BUSY ] Probing issue ticket #1...",
        ...
        pytest.param(
            f"--pfm {envr['TEST_PFM']} --srce {envr['TEST_SRCE']} --dest {envr['TEST_DEST']} --pkey {envr['TEST_PKEY']} --gkey {envr['TEST_GKEY']} --fusr {envr['TEST_FUSR']} --tusr {envr['TEST_TUSR']} tkts --status FULL --select 1,2 --series",  # noqa: E501
            0,
            [
                "[ WARN ] Extracting all issue tickets without labels, without states, without privacy, without comments and with order off the given selection",  # noqa: E501
                "[ BUSY ] Probing issue ticket #1...",
