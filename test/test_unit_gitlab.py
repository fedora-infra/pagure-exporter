...
def test_unit_gitlab_iterstat(caplog, srce, dest, pkey, gkey, fusr, tusr, root, tkid, shut, rslt):
    standard.pagure_user, standard.pagure_token, standard.source_repo = fusr, pkey, srce
    standard.gitlab_user, standard.gitlab_token, standard.destination_repo = tusr, gkey, dest
    standard.gitlab_issue_id, standard.gitlab_api, standard.issue_closed = tkid, root, shut
    test_movetkts = MoveTickets()
