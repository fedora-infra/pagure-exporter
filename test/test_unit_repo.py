...
def test_unit_downsrce(caplog, srcename, destname, gkey, pkey, fusr, tusr, rslt):
    ...
    standard.source_clone_url = f"https://{standard.pagure_user}:{standard.pagure_token}@{standard.forge_source}/{srcename}.git"
    standard.destination_clone_url = f"https://{standard.gitlab_user}:{standard.gitlab_token}@{standard.forge_dest}/{destname}.git"
